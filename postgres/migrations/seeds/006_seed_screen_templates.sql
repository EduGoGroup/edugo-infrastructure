...
('a0000000-0000-0000-0000-000000000003', 'list', 'list-basic-v1', 'Lista con busqueda, filtros, estado vacio, elementos', 1, '{
  ...
  "platformOverrides": {
    "desktop": {
      "zones": {
        "list_content": {"distribution": "master-detail", "weights": [0.4, 0.6]}
      }
    },
    "web": {
      "zones": {
...
('a0000000-0000-0000-0000-000000000005', 'settings', 'settings-basic-v1', 'Configuracion con secciones agrupadas', 1, '{
  ...
  "zones": [
    ...
    },
    {
      ...
      "type": "form-section",
      "slots": [
        {"id": "account_title", "controlType": "label", "style": "title-medium", "bind": "slot:account_title"},
        {"id": "change_password", "controlType": "list-item-navigation", "bind": "slot:change_password_label", "icon": "lock"},
        {"id": "language", "controlType": "list-item-navigation", "bind": "slot:language_label", "icon": "language", "field": "preferences.language"}
      ]
    },
    {
      "id": "section_about",
      "type": "form-section",
      "slots": [
        {"id": "about_title", "controlType": "label", "style": "title-medium", "bind": "slot:about_title"},
        {"id": "version", "controlType": "list-item", "bind": "slot:version_label"},
        {"id": "privacy_policy", "controlType": "list-item-navigation", "bind": "slot:privacy_label", "icon": "privacy_tip"},
        {"id": "terms", "controlType": "list-item-navigation", "bind": "slot:terms_label", "icon": "description"}
      ]
    },
    {
      "id": "logout",
  ...
  "platformOverrides": {
    "desktop": {
      ...
      "weights": [0.3, 0.7],
      "zones": {
        "user_card": {"panel": "left"},
        "section_appearance": {"panel": "right"},
        "section_notifications": {"panel": "right"},
