...
const (
	...
	// dashboards (5 roles + stats-dashboard)
	// Eliminado (2026-06-15): L4_SCREEN_INST_PROGRESS_DASH_ID (…15); su UUID
	// queda libre. progress-dashboard apuntaba a /api/v1/stats/student
	...
	// 0087 era assessment-assignment — eliminado (reemplazado por modal nativo).
	// 0088 era assessment-modality — eliminado en plan 015 (concepto muerto).
