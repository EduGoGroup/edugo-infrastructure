...
func assessmentsForm() l4ScreenInstanceRow {
  ...
  "actions_added": [
    ...
    {"id": "reviews", "scope": "resource-toolbar", "icon": "checklist",   "label": "Revisiones", "permission": "content.assessments.read",   "condition": "edit-only", "event_id": "view-reviews",   "style": "icon", "order": 25, "visible_when": {"field": "status", "equals": "published"}},
