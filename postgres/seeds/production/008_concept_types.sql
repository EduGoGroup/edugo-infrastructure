-- ====================================================================
-- SEEDS: Tipos de concepto y definiciones de terminología
...
INSERT INTO academic.concept_types (id, name, code, description) VALUES
    ('c1000000-0000-0000-0000-000000000001', 'Escuela Primaria',    'primary_school',    'Institución de educación básica'),
    ('c1000000-0000-0000-0000-000000000002', 'Colegio Secundario',  'high_school',       'Institución de educación media'),
    ('c1000000-0000-0000-0000-000000000003', 'Academia de Idiomas', 'language_academy',  'Centro de enseñanza de idiomas'),
    ('c1000000-0000-0000-0000-000000000004', 'Instituto Técnico',   'technical_school',  'Formación técnica y profesional'),
    ('c1000000-0000-0000-0000-000000000005', 'Taller / Workshop',   'workshop',          'Cursos cortos y talleres prácticos')
...
INSERT INTO academic.concept_definitions (concept_type_id, term_key, term_value, category, sort_order) VALUES
    ...
    ('c1000000-0000-0000-0000-000000000001', 'unit.period',           'Período',       'unit',    5),
    ...
    ('c1000000-0000-0000-0000-000000000001', 'content.assessment',    'Evaluación',    'content', 10)
...
INSERT INTO academic.concept_definitions (concept_type_id, term_key, term_value, category, sort_order) VALUES
    ...
    ('c1000000-0000-0000-0000-000000000002', 'unit.level1',           'Año',           'unit',    3),
    ('c1000000-0000-0000-0000-000000000002', 'unit.level2',           'División',      'unit',    4),
...
-- Definiciones para "Instituto Técnico"
INSERT INTO academic.concept_definitions (concept_type_id, term_key, term_value, category, sort_order) VALUES
    ...
    ('c1000000-0000-0000-0000-000000000004', 'unit.level2',           'Sección',       'unit',    4),
    ...
    ('c1000000-0000-0000-0000-000000000004', 'content.subject',       'Módulo',        'content', 9),
...
INSERT INTO academic.concept_definitions (concept_type_id, term_key, term_value, category, sort_order) VALUES
    ...
    ('c1000000-0000-0000-0000-000000000005', 'unit.level1',           'Módulo',        'unit',    3),
