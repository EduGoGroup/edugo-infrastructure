...
type Progress struct {
	...
	UserID             uuid.UUID       `db:"user_id" gorm:"type:uuid;primaryKey;constraint:progress_user_fkey,OnDelete:CASCADE" validate:"required,uuid"`
	ProgressPercentage float64         `db:"progress_percentage" gorm:"column:progress_percentage;type:numeric(5,2);not null;default:0" validate:"required"`
