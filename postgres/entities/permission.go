...
type Permission struct {
	...
	Name        string    `db:"name" gorm:"uniqueIndex:permissions_name_key;not null;size:100;check:chk_permission_name_format,name ~ '^(\\*|[a-z_]+(\\.[a-z_]+){0,2}(\\.\\*)?)(:own)?$'" validate:"required,min=2,max=100"`
