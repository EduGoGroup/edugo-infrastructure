...
| Levantar runtime local | `docker` | Postgres, RabbitMQ, Redis y herramientas visuales | [../docker/docs/processes.md](../docker/docs/processes.md) |
...
3. `schemas` para contratos de mensajeria.
4. `tools/mock-generator` para artefactos de dataset.
5. `automation.md` para entender lo que hoy esta alineado y lo que no.
